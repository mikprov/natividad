...
# Standardize the standard integrals so values range 0-1
# -------------------------------------------

m1hold <- round(site_stress_values$integral_m1 / site_stress_values$days_in_ts_m1,digits=2)
site_stress_values$integral_m1_S <- # stress1
  round(m1hold / sum(m1hold),digits=2)

m2hold <- round(site_stress_values$integral_m2 / site_stress_values$days_in_ts_m2,digits=2)
site_stress_values$integral_m2_S <- #stress2
  round(m2hold / sum(m2hold),digits=2)
  
m3ahold <- round(site_stress_values$integral_m3a / site_stress_values$days_in_ts_m3,digits=2)
site_stress_values$integral_m3a_S <- #stress3: minus, integrate
  round(m3ahold / sum(m3ahold),digits=2)
  
m3bhold <- round(site_stress_values$integral_m3b / site_stress_values$days_in_ts_m3,digits=2)
site_stress_values$integral_m3b_S <- #stress3: integrate, minus
  round(m3bhold / sum(m3bhold),digits=2)
  
m4devhold <- round(site_stress_values$integral_m4dev / site_stress_values$days_in_ts_m4,digits=2)
site_stress_values$integral_m4dev_S <- #stress4: deviations
  round(m4devhold / sum(m4devbhold),digits=2)

m4abhold <- round(site_stress_values$integral_m4abs / site_stress_values$days_in_ts_m4,digits=2)
site_stress_values$integral_m4abs_S <- #stress4: absolute temp
  round(m4abhold / sum(m4abbhold),digits=2)
  
rm(m1hold,m2hold,m3ahold,m3bhold,m4devhold,m4abhold)
