...
for(s in 1:length(site_vector)){ #for each site
  ...
  site_stress_values[site_stress_values$Site == site_vector[s],]$days_int_ts_m2 <-
...
#   ifelse(bottomall_stress$stress3_clim_minus_thres_max < 0,0,bottomall_stress$clim_minus_thres_max) 
...
site_stress_values$integral_m3_minus_m1 <- 
  site_stress_values$integral_m3 - auc_method1$integral_m1_S
