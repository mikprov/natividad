...
tiff(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript1_figs/figS1_temp_time_series_partA.tiff", res=300, height = 12, width = 9, units="in")
do.call("grid.arrange", c(pL[1:8], ncol = 2)) 
dev.off()

tiff(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript1_figs/figS1_temp_time_series_partB.tiff", res=300, height = 12, width = 9, units="in")
...
# --------------------------------------
# 2. calc high freq variance in SST
# (a) using deviations from climatology (original method)
# (b) using power spectrum (same method used for bottom temp)
# --------------------------------------
...
tiff(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript1_figs/figSX_sst_spectra.tiff", res=300, height = 24, width = 9, units="in")
do.call("grid.arrange", c(pSSTsp,ncol = 2)) 
dev.off()
tiff(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript1_figs/figSX_sst_spectra_logxaxis.tiff", res=300, height = 24, width = 9, units="in")
...
rm(spRdf,d,s,spR,site_vector,sampleinterval)
tiff(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript1_figs/figSX_bottom_spectra.tiff", res=300, height = 24, width = 9, units="in")
do.call("grid.arrange", c(pBR,ncol = 2)) 
dev.off()
tiff(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript1_figs/figSX_bottom_spectra_logxaxis.tiff", res=300, height = 24, width = 9, units="in")
...
# lm_eqn_origin <- function(df){ # function to paste regression & r2 on plot
#   x = df$highvar_bottom
#   y = df$variance_SST
#     m <- lm(y ~ 0 + x, df)
...
log_eqn_mean <- function(df){ # function to paste regression & r2 on plot
...
fig1a <- ggplot(data=regdf,aes(x=highvar_sst, y=highvar_bottom,color=upwelling)) +
  ...
  #geom_point(data=regdf_strong,aes(x=highvar_bottom, y=variance_SST),color="seagreen3") +
  #geom_point(data=regdf_weak,aes(x=highvar_bottom, y=variance_SST),color="dodgerblue") +
  ...
  #                 aes(x=highvar_bottom, y=variance_SST,label = Site),
  #                 color="seagreen2",
  #                 segment.color = "seagreen2",
  #                 size = 3,
  #                 na.rm = TRUE,
  #                 box.padding = 0.5) 

tiff(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript1_figs/fig2_regression_plot_v1.tiff", res=300, height = 6, width = 7, units="in")
fig1a
dev.off()

jpeg(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript1_figs/fig2_regression_plot_v2.jpeg", res=400, height = 6, width = 7, units="in")
fig1a
dev.off()
  # ggtitle("Grey line = weak upwelling\nBlue line = strong upwelling\nRed Line = all sites\nLight green = all sites\nDark green = strong upwelling")

rm(logdata_all,logdata_strong,xsst)
...
tiff(file="C:/Users/Mikaela/Documents/GitHub/natividad/manuscript1_figs/fig1abc.tiff", 
