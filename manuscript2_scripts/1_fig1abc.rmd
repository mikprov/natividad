...
for(s in 1:length(site_vector)){
  pL[[s]] <- ggplot(data=pdf[pdf$Site==site_vector[s],]) +
    scale_colour_manual(name="",
                        values=c(temp_bottom="orange", SST="lightblue")) +
    geom_line(aes(x=Date,y=SST,color="SST")) +
    geom_line(aes(x=Date,y=Climatology),color="lightblue") +
    geom_line(aes(x=Date,y=temp_bottom,color="temp_bottom")) +
    theme_classic() +
...
jpeg(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript2_figs/figS1_sst_logger_temp_time_series_partA.jpeg", res=300, height = 10, width = 8, units="in")
do.call("grid.arrange", c(pL[1:8], ncol = 2)) 
dev.off()

jpeg(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript2_figs/figS1_sst_logger_time_series_partB.jpeg", res=300, height = 10, width = 8, units="in")
...
jpeg(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript2_figs/figS2_sst_spectra.jpeg", res=300, height = 11, width = 9, units="in")
do.call("grid.arrange", c(pSSTsp,ncol = 3)) 
dev.off()
jpeg(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript2_figs/figS2_sst_spectra_logxaxis.jpeg", res=300, height = 11, width = 9, units="in")
do.call("grid.arrange", c(pSSTsplog,ncol = 3)) 
dev.off()
rm(pSSTsplog,pSSTsp)
...
rm(spRdf,d,s,spR,site_vector,sampleinterval)
jpeg(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript2_figs/figS3_bottom_spectra.jpeg", res=300, height = 11, width = 9, units="in")
do.call("grid.arrange", c(pBR,ncol = 3)) 
dev.off()
jpeg(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript2_figs/figS3_bottom_spectra_logxaxis.jpeg", res=300, height = 11, width = 9, units="in")
do.call("grid.arrange", c(pBRlog,ncol = 3)) 
dev.off()
rm(pBRlog,pBR)
...
jpeg(filename = "C:/Users/Mikaela/Documents/GitHub/natividad/manuscript2_figs/figS4_all5_regressions_plot.jpeg", res=300, height = 6, width = 7, units="in")
figS4
dev.off()
...
cols <- c("SST" = "lightblue", "Bottom" = "orange")
for(s in 1:length(site_vector)){
...
jpeg(file="C:/Users/Mikaela/Documents/GitHub/natividad/manuscript2_figs/fig1abc.jpeg", 
...
rm(left_col,fig1a,fig1b,fig1c,pL)
